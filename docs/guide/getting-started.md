...
- We provide a distinct command name `gatic` to avoid collisions with other OSS projects.
- You can still run without global install using `npx gatic <command>` if preferred.
