...
| Milestone | Scope                           |
| --------- | ------------------------------- |
| M1        | Handler/Module runtime with CLI |
| M2        | Kubernetes deploy + AWS plugin  |
| M3        | Version diff analyzer           |
| M4        | Control Panel (limited) + Logs  |
| M5        | SDK codegen + Playground        |
| M6        | CDN + SSL automation            |
| M7        | Effects + async jobs            |
